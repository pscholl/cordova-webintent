...
public class WebIntent extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        try {
            ...
            if (action.equals("startActivity")) {
                ...
                Bundle extras = obj.has("extras") ? fromJson(obj.getJSONObject("extras")) : null;
            ...
            } else if (action.equals("sendBroadcast")) 
            {
                ...
                sendBroadcast(obj.getString("action"), extras);
                callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK));
                return true;
            }
    ...
    void startActivity(String action, Uri uri, String type, Bundle extras) {
        ...
        for (String key : extras.keySet()) {
            ...
            if (key.equals(Intent.EXTRA_TEXT) && type.equals("text/html")) {
                extras.putCharSequence(key, Html.fromHtml(value));
            } else if (key.equals(Intent.EXTRA_STREAM)) {
                // allows sharing of images as attachments.
                // value in this case should be a URI of a file
                final CordovaResourceApi resourceApi = webView.getResourceApi();
                extras.putParcelable(key, resourceApi.remapUri(Uri.parse(value)));
            } else if (key.equals(Intent.EXTRA_EMAIL)) {
                // allows to add the email address of the receiver
                extras.putStringArray(Intent.EXTRA_EMAIL, new String[] { value });
            }
        }
    ...
    void sendBroadcast(String action, Bundle extras) {
